...
/**
 * Find subject (forum) by slug or ID
 * @param {string|number} identifier - Subject slug or ID
 * @returns {Promise<Object|null>} - The subject object or null
 */
export async function findSubjectBySlugOrId(identifier) {
  // Try to parse as number first
  const numericId = parseInt(identifier);
